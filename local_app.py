...
.brandmark[src^="/assets/site-logo"],.loginbrand img[src^="/assets/site-logo"],.hero-logo[src^="/assets/site-logo"]{object-fit:cover;padding:0;background:transparent}.brandmark[src^="/assets/site-logo"]{width:104px;height:40px;border-radius:10px}.loginbrand img[src^="/assets/site-logo"]{width:152px;height:57px;border-radius:14px}.hero-logo[src^="/assets/site-logo"]{width:240px;height:90px;border-radius:18px}
@media(max-width:850px){.brandmark[src^="/assets/site-logo"]{width:96px;height:36px}.loginbrand img[src^="/assets/site-logo"]{width:136px;height:51px}.hero-logo[src^="/assets/site-logo"]{width:184px;height:69px}}
"""
